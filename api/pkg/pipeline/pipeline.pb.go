...
var file_api_pkg_pipeline_pb_pipeline_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x22, 0x52, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x37,
	...
	0x79, 0x22, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x36, 0x0a, 0x11, 0x43, 0x61, 0x6e, 0x63, 0x65,
	...
	0x0c, 0x61, 0x75, 0x64, 0x69, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x84, 0x01,
	...
	0x02, 0x32, 0xc7, 0x08, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x57, 0x0a,
	...
	0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e,
	0x65, 0x2e, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x51, 0x0a, 0x0c, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x2e, 0x77, 0x6f, 0x72,
	...
	0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x52, 0x0a,
	...
	0x74, 0x12, 0x55, 0x0a, 0x0e, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x41, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x28, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x70,
	...
	0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e,
	0x65, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x51, 0x0a, 0x0c, 0x44, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x66,
	...
	0x6c, 0x69, 0x6e, 0x65, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x31, 0x5a, 0x2f, 0x67,
	...
	0x69, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x62, 0x06,
...
var file_api_pkg_pipeline_pb_pipeline_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_api_pkg_pipeline_pb_pipeline_proto_goTypes = []interface{}{
	...
	(*CancelStepRequest)(nil),       // 29: workflow.pipeline.CancelStepRequest
	(*AuditStepRequest)(nil),        // 30: workflow.pipeline.AuditStepRequest
	nil,                             // 31: workflow.pipeline.Pipeline.WithEntry
	nil,                             // 32: workflow.pipeline.Pipeline.TagsEntry
	...
	nil,                             // 42: workflow.pipeline.Action.RunnerParamsEntry
	nil,                             // 43: workflow.pipeline.Action.RunParamsEntry
	nil,                             // 44: workflow.pipeline.Action.TagsEntry
	nil,                             // 45: workflow.pipeline.CreateActionRequest.RunnerParamsEntry
	nil,                             // 46: workflow.pipeline.CreateActionRequest.RunParamsEntry
	nil,                             // 47: workflow.pipeline.CreateActionRequest.TagsEntry
	(*page.PageRequest)(nil),        // 48: page.PageRequest
	(resource.VisiableMode)(0),      // 49: mcube.resource.VisiableMode
}
var file_api_pkg_pipeline_pb_pipeline_proto_depIdxs = []int32{
	31, // 0: workflow.pipeline.Pipeline.with:type_name -> workflow.pipeline.Pipeline.WithEntry
	5,  // 1: workflow.pipeline.Pipeline.mount:type_name -> workflow.pipeline.MountData
	32, // 2: workflow.pipeline.Pipeline.tags:type_name -> workflow.pipeline.Pipeline.TagsEntry
	...
	33, // 8: workflow.pipeline.Step.with:type_name -> workflow.pipeline.Step.WithEntry
	34, // 9: workflow.pipeline.Step.audit_params:type_name -> workflow.pipeline.Step.AuditParamsEntry
	35, // 10: workflow.pipeline.Step.notify_params:type_name -> workflow.pipeline.Step.NotifyParamsEntry
	10, // 11: workflow.pipeline.Step.webhook:type_name -> workflow.pipeline.WebHook
	36, // 12: workflow.pipeline.Step.node_selector:type_name -> workflow.pipeline.Step.NodeSelectorEntry
	11, // 13: workflow.pipeline.Step.status:type_name -> workflow.pipeline.StepStatus
	37, // 14: workflow.pipeline.WebHook.header:type_name -> workflow.pipeline.WebHook.HeaderEntry
	...
	38, // 18: workflow.pipeline.StepStatus.response:type_name -> workflow.pipeline.StepStatus.ResponseEntry
	39, // 19: workflow.pipeline.StepStatus.context_map:type_name -> workflow.pipeline.StepStatus.ContextMapEntry
	9,  // 20: workflow.pipeline.StepSet.items:type_name -> workflow.pipeline.Step
	48, // 21: workflow.pipeline.QueryStepRequest.page:type_name -> page.PageRequest
	...
	40, // 24: workflow.pipeline.CreatePipelineRequest.with:type_name -> workflow.pipeline.CreatePipelineRequest.WithEntry
	5,  // 25: workflow.pipeline.CreatePipelineRequest.mount:type_name -> workflow.pipeline.MountData
	41, // 26: workflow.pipeline.CreatePipelineRequest.tags:type_name -> workflow.pipeline.CreatePipelineRequest.TagsEntry
	...
	48, // 29: workflow.pipeline.QueryPipelineRequest.page:type_name -> page.PageRequest
	49, // 30: workflow.pipeline.Action.visiable_mode:type_name -> mcube.resource.VisiableMode
	2,  // 31: workflow.pipeline.Action.runner_type:type_name -> workflow.pipeline.RUNNER_TYPE
	42, // 32: workflow.pipeline.Action.runner_params:type_name -> workflow.pipeline.Action.RunnerParamsEntry
	43, // 33: workflow.pipeline.Action.run_params:type_name -> workflow.pipeline.Action.RunParamsEntry
	44, // 34: workflow.pipeline.Action.tags:type_name -> workflow.pipeline.Action.TagsEntry
	...
	49, // 37: workflow.pipeline.CreateActionRequest.visiable_mode:type_name -> mcube.resource.VisiableMode
	45, // 38: workflow.pipeline.CreateActionRequest.runner_params:type_name -> workflow.pipeline.CreateActionRequest.RunnerParamsEntry
	46, // 39: workflow.pipeline.CreateActionRequest.run_params:type_name -> workflow.pipeline.CreateActionRequest.RunParamsEntry
	47, // 40: workflow.pipeline.CreateActionRequest.tags:type_name -> workflow.pipeline.CreateActionRequest.TagsEntry
	49, // 41: workflow.pipeline.DeleteActionRequest.visiable_mode:type_name -> mcube.resource.VisiableMode
	48, // 42: workflow.pipeline.QueryActionRequest.page:type_name -> page.PageRequest
	3,  // 43: workflow.pipeline.AuditStepRequest.audit_reponse:type_name -> workflow.pipeline.AUDIT_RESPONSE
	20, // 44: workflow.pipeline.Action.RunnerParamsEntry.value:type_name -> workflow.pipeline.ParamValueDesc
	20, // 45: workflow.pipeline.Action.RunParamsEntry.value:type_name -> workflow.pipeline.ParamValueDesc
	20, // 46: workflow.pipeline.CreateActionRequest.RunnerParamsEntry.value:type_name -> workflow.pipeline.ParamValueDesc
	20, // 47: workflow.pipeline.CreateActionRequest.RunParamsEntry.value:type_name -> workflow.pipeline.ParamValueDesc
	17, // 48: workflow.pipeline.Service.CreatePipeline:input_type -> workflow.pipeline.CreatePipelineRequest
	18, // 49: workflow.pipeline.Service.QueryPipeline:input_type -> workflow.pipeline.QueryPipelineRequest
	27, // 50: workflow.pipeline.Service.DescribePipeline:input_type -> workflow.pipeline.DescribePipelineRequest
	13, // 51: workflow.pipeline.Service.QueryStep:input_type -> workflow.pipeline.QueryStepRequest
	14, // 52: workflow.pipeline.Service.DescribeStep:input_type -> workflow.pipeline.DescribeStepRequest
	28, // 53: workflow.pipeline.Service.DeleteStep:input_type -> workflow.pipeline.DeleteStepRequest
	29, // 54: workflow.pipeline.Service.CancelStep:input_type -> workflow.pipeline.CancelStepRequest
	30, // 55: workflow.pipeline.Service.AuditStep:input_type -> workflow.pipeline.AuditStepRequest
	26, // 56: workflow.pipeline.Service.DeletePipeline:input_type -> workflow.pipeline.DeletePipelineRequest
	22, // 57: workflow.pipeline.Service.CreateAction:input_type -> workflow.pipeline.CreateActionRequest
	25, // 58: workflow.pipeline.Service.QueryAction:input_type -> workflow.pipeline.QueryActionRequest
	23, // 59: workflow.pipeline.Service.DescribeAction:input_type -> workflow.pipeline.DescribeActionRequest
	24, // 60: workflow.pipeline.Service.DeleteAction:input_type -> workflow.pipeline.DeleteActionRequest
	4,  // 61: workflow.pipeline.Service.CreatePipeline:output_type -> workflow.pipeline.Pipeline
	16, // 62: workflow.pipeline.Service.QueryPipeline:output_type -> workflow.pipeline.PipelineSet
	4,  // 63: workflow.pipeline.Service.DescribePipeline:output_type -> workflow.pipeline.Pipeline
	12, // 64: workflow.pipeline.Service.QueryStep:output_type -> workflow.pipeline.StepSet
	9,  // 65: workflow.pipeline.Service.DescribeStep:output_type -> workflow.pipeline.Step
	9,  // 66: workflow.pipeline.Service.DeleteStep:output_type -> workflow.pipeline.Step
	9,  // 67: workflow.pipeline.Service.CancelStep:output_type -> workflow.pipeline.Step
	9,  // 68: workflow.pipeline.Service.AuditStep:output_type -> workflow.pipeline.Step
	4,  // 69: workflow.pipeline.Service.DeletePipeline:output_type -> workflow.pipeline.Pipeline
	19, // 70: workflow.pipeline.Service.CreateAction:output_type -> workflow.pipeline.Action
	21, // 71: workflow.pipeline.Service.QueryAction:output_type -> workflow.pipeline.ActionSet
	19, // 72: workflow.pipeline.Service.DescribeAction:output_type -> workflow.pipeline.Action
	19, // 73: workflow.pipeline.Service.DeleteAction:output_type -> workflow.pipeline.Action

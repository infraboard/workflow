...
type PipelineTask struct {
	...
	// 需要被运行的Pipeline对象
	Pipeline *pipeline.Pipeline `protobuf:"bytes,2,opt,name=pipeline,proto3" json:"pipeline,omitempty" bson:"pipeline"`
	// 创建时间
	CreateAt int64 `protobuf:"varint,3,opt,name=create_at,json=createAt,proto3" json:"create_at,omitempty" bson:"create_at"`
	// 开始时间
	StartAt int64 `protobuf:"varint,4,opt,name=start_at,json=startAt,proto3" json:"start_at,omitempty" bson:"start_at"`
	// 结束时间
	EndAt int64 `protobuf:"varint,5,opt,name=end_at,json=endAt,proto3" json:"end_at,omitempty" bson:"end_at"`
	// 状态更新的时间
	UpdateAt int64 `protobuf:"varint,6,opt,name=update_at,json=updateAt,proto3" json:"update_at,omitempty" bson:"update_at"`
	// 任务状态
	Status PIPELINE_STATUS `protobuf:"varint,7,opt,name=status,proto3,enum=workflow.task.PIPELINE_STATUS" json:"status,omitempty" bson:"status"`
	// 执行结果
	Message string `protobuf:"bytes,8,opt,name=message,proto3" json:"message,omitempty" bson:"message"`
}
...
type PipelineTaskSet struct {
	...
	Items []*PipelineTask `protobuf:"bytes,2,rep,name=items,proto3" json:"items,omitempty" bson:"items"`
}
